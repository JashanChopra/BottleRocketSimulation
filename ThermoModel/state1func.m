function [ds,Fthrust] = state1func(t,state1Vec,Cd,Athroat,gamma,rhoAtm,Patm,Pgage,volAir,Abottle,mBottle,mAir,CDrag,volBottle,rhoWater,vw)
...
if sqrt(x^2+z^2) < 0.531678
   ...
   Fthrust = 2*Cd*Athroat*(P - Patm);               % Thrust Force Equation
